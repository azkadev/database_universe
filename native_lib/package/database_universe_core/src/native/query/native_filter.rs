...
use crate::native::database_universe_deserializer::DatabaseUniverseDeserializer;
...
impl NativeFilter {
    ...
    pub(crate) fn evaluate(&self, id: i64, object: DatabaseUniverseDeserializer) -> bool {
...
trait Condition {
    fn evaluate(&self, id: i64, object: DatabaseUniverseDeserializer) -> bool;
}
...
impl Condition for IsNullCond {
    fn evaluate(&self, _id: i64, object: DatabaseUniverseDeserializer) -> bool {
...
impl Condition for IdBetweenCond {
    #[inline]
    fn evaluate(&self, id: i64, _object: DatabaseUniverseDeserializer) -> bool {
...
impl Condition for StaticCond {
    fn evaluate(&self, _id: i64, _: DatabaseUniverseDeserializer) -> bool {
        self.value
    }
}
