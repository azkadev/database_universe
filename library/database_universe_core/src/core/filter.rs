...
pub struct FilterCondition {
    ...
    pub values: Vec<Option<DatabaseUniverseValue>>,
...
impl FilterCondition {
    pub const fn new(
        ...
        values: Vec<Option<DatabaseUniverseValue>>,
        case_sensitive: bool,
    ) -> Self {
        Self {
            property_index,
    ...
    pub fn new(
        ...
        let values = if case_sensitive {
            ...
            values
                ...
                .map(|v| {
                    v.map(|v| {
                        if let DatabaseUniverseValue::String(s) = v {
                            DatabaseUniverseValue::String(s.to_lowercase())
                        } else {
                            v
                        }
                    })
