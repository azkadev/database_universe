...
void main() {
  group('Query property', () {
    ...
    databaseUniverseTest('id property', () {
      isar.write(
    ...
    databaseUniverseTest('bool property', () {
      isar.write(
        (isar) => isar.boolModels.putAll([
          BoolModel(0)
            ..value = true
    ...
    databaseUniverseTest('byte property', () {
      isar.write(
    ...
    databaseUniverseTest('short property', () {
      isar.write(
    ...
    databaseUniverseTest('int property', () {
      isar.write(
    ...
    databaseUniverseTest('float property', () {
      isar.write(
    ...
    databaseUniverseTest('double property', () {
      isar.write(
    ...
    databaseUniverseTest('DateTime property', () {
      isar.write(
    ...
    databaseUniverseTest('String property', () {
      isar.write(
    ...
    databaseUniverseTest('Object property', () {
      isar.write(
    ...
    databaseUniverseTest('Enum property', () {
      isar.write(
    ...
    databaseUniverseTest('bool list property', () {
      isar.write(
        (isar) => isar.boolModels.putAll([
          BoolModel(0)
    ...
    databaseUniverseTest('byte list property', () {
      isar.write(
        (isar) => isar.byteModels.putAll([
    ...
    databaseUniverseTest('short list property', () {
      isar.write(
        (isar) => isar.shortModels.putAll([
          ShortModel(0)
            ..list = [-5, 70, 999]
    ...
    databaseUniverseTest('int list property', () {
      isar.write(
        (isar) => isar.intModels.putAll([
          IntModel(0)
            ..list = [-5, 70, 999]
    ...
    databaseUniverseTest('float list property', () {
      isar.write(
        (isar) => isar.floatModels.putAll([
          FloatModel(0)
    ...
    databaseUniverseTest('double list property', () {
      isar.write(
        (isar) => isar.doubleModels.putAll([
          DoubleModel(0)
            ..list = [-5.5, 70.7, 999.999]
    ...
    databaseUniverseTest('DateTime list property', () {
      isar.write(
        (isar) => isar.dateTimeModels.putAll([
          DateTimeModel(0)
    ...
    databaseUniverseTest('String list property', () {
      isar.write(
        (isar) => isar.stringModels.putAll([
    ...
    databaseUniverseTest('Object list property', () {
      isar.write(
        (isar) => isar.objectModels.putAll([
          ObjectModel(0)
            ..list = []
    ...
    databaseUniverseTest('Enum list property', () {
      isar.write(
        (isar) => isar.enumModels.putAll([
          EnumModel(0)
