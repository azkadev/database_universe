...
void main() {
  group('Sort By', () {
    ...
    databaseUniverseTest('.sortByDesc()', () {
      expect(
    ...
    databaseUniverseTest('.sortBy().thenBy()', () {
      expect(
    ...
    databaseUniverseTest('.sortBy().thenByDesc()', () {
      expect(
    ...
    databaseUniverseTest('.sortBy().thenBy().thenBy()', () {
      expect(
