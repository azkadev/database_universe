...
void main() {
  group('Multi filters', () {
    ...
    group('filter anyOf', () {
      databaseUniverseTest('zero elements', () {
      ...
      databaseUniverseTest('one matching element', () {
        final q = isar.models.where().anyOf(
          [2],
          (q, int element) => q.valueEqualTo(element),
        );
      ...
      databaseUniverseTest('two matching elements', () {
        final q = isar.models.where().anyOf(
          [0, 2],
          (q, int element) => q.valueEqualTo(element),
        );
      ...
      databaseUniverseTest('one non-matching element', () {
        final q = isar.models.where().anyOf(
          [5],
          (q, int element) => q.valueEqualTo(element),
        );
      ...
      databaseUniverseTest('one matching and one non-matching elements', () {
        final q = isar.models.where().anyOf(
          [7, 3],
          (q, int element) => q.valueEqualTo(element),
        );
