...
void main() {
  group('Encryption', () {
    databaseUniverseTest('Correct key', isar: false, web: false, () async {
    ...
    databaseUniverseTest('Wrong key', isar: false, web: false, () async {
      final isarName = getRandomName();
      final isar = await openTempIsar(
        [ModelSchema],
        name: isarName,
    ...
    databaseUniverseTest('Change key', isar: false, web: false, () async {
      final isarName = getRandomName();
