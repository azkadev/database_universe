...
void main() {
  group('Collection size', () {
    ...
    databaseUniverseTest('Size should start at 0', sqlite: false, web: false, () {
    ...
    /*databaseUniverseTest('includeIndexes should change size', () {
    ...
    databaseUniverseTest('Delete should decrease size', sqlite: false, web: false, () {
      isar.write((isar) {
    ...
    databaseUniverseTest('Update should change size', sqlite: false, web: false, () {
      isar.write((isar) {
        isar.modelAs.putAll([objA0, objA1, objA2, objA3]);
        isar.modelBs.putAll([objB0, objB1, objB2, objB3, objB4]);
      });
