...
void main() {
  group('String list filter', () {
    ...
    databaseUniverseTest('.elementStartWith()', () {
      expect(
    ...
    databaseUniverseTest('.elementEndsWith()', () {
      expect(
    ...
    databaseUniverseTest('.elementContains()', () {
      expect(
    ...
    databaseUniverseTest('.elementMatches()', () {
      expect(
    ...
    databaseUniverseTest('.elementIsEmpty()', () {
      expect(
    ...
    databaseUniverseTest('.elementIsNotEmpty()', () {
      expect(
