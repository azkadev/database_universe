...
void main() {
  group('Copy to file', () {
    ...
    databaseUniverseTest('.copyToFile() should create a new file', () {
    ...
    databaseUniverseTest('.copyToFile() should keep the same content', () async {
    ...
    databaseUniverseTest('.copyToFile() should compact copied file', () async {
      final dbFile = File(
        path.join(
          isar.directory,
    ...
    databaseUniverseTest('Copies should be the same size', () async {
      final name1 = getRandomName();
      final copiedDbFile1 = File(
        path.join(isar.directory, isSQLite ? '$name1.sqlite' : '$name1.isar'),
      );
