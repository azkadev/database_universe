...
void main() {
  group('Transaction', () {
    ...
    databaseUniverseTest('Sync txn cannot be opened in sync txn', () {
      isar.read((isar) {
    ...
    databaseUniverseTest('Asyc txn cannot be opened in sync txn', () async {
      isar.read((isar) {
    ...
    databaseUniverseTest('gets reverted on error', () {
    ...
    databaseUniverseTest('Write operations require write transaction', () {
