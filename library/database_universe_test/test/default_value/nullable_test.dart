...
void main() {
  group('Nullable value', () {
    databaseUniverseTest('scalar', web: false, () async {
    ...
    databaseUniverseTest('scalar property', web: false, () async {
      final emptyObj = EmptyModel(0);
      final isar1 = await openTempIsar([EmptyModelSchema]);
      isar1.write((isar) => isar.emptyModels.put(emptyObj));
      final isarName = isar1.name;
    ...
    databaseUniverseTest('list', web: false, () async {
      final emptyObj = EmptyModel(0);
      final isar1 = await openTempIsar([EmptyModelSchema]);
      isar1.write((isar) => isar.emptyModels.put(emptyObj));
      final isarName = isar1.name;
      ...
      final isar2 = await openTempIsar([NullableListModelSchema], name: isarName);
    ...
    databaseUniverseTest('list property', web: false, () async {
      final emptyObj = EmptyModel(0);
      final isar1 = await openTempIsar([EmptyModelSchema]);
      isar1.write((isar) => isar.emptyModels.put(emptyObj));
      final isarName = isar1.name;
