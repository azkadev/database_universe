...
void main() {
  group('Constructor', () {
    ...
    databaseUniverseTest('EmptyConstructorModel', () {
    ...
    databaseUniverseTest('NamedConstructorModel', () {
    ...
    databaseUniverseTest('PositionalConstructorModel', () {
    ...
    databaseUniverseTest('OptionalConstructorModel', () {
    ...
    databaseUniverseTest('PositionalNamedConstructorModel', () {
