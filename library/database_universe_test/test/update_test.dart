...
void main() {
  group('Update', () {
    ...
    group('update()', () {
      databaseUniverseTest('bool change', () {
        isar.write((isar) {
      ...
      databaseUniverseTest('bool change to null', () {
        isar.write((isar) {
          expect(
      ...
      databaseUniverseTest('byte change', () {
        isar.write((isar) {
      ...
      databaseUniverseTest('short change', () {
        isar.write((isar) {
      ...
      databaseUniverseTest('long change', () {
        isar.write((isar) {
      ...
      databaseUniverseTest('float change', () {
        isar.write((isar) {
      ...
      databaseUniverseTest('double change', () {
        isar.write((isar) {
      ...
      databaseUniverseTest('string change', () {
        isar.write((isar) {
      ...
      databaseUniverseTest('nullable string change', () {
        isar.write((isar) {
          expect(
      ...
      databaseUniverseTest('date change', () {
        isar.write((isar) {
          expect(
            isar.models.update(
              id: model.id,
