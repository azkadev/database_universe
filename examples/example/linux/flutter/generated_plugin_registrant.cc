...
void fl_register_plugins(FlPluginRegistry* registry) {
  g_autoptr(FlPluginRegistrar) database_universe_flutter_registrar =
      fl_plugin_registry_get_registrar_for_plugin(registry, "DatabaseUniverseFlutterPlugin");
  database_universe_flutter_plugin_register_with_registrar(database_universe_flutter_registrar);
