...
///
class ExampleClientFlutter extends GeneralFrameworkClientFlutter<ExampleClient> {
  ////
  ...
  @override
  FutureOr<void> ensureInitialized({required BuildContext context, required FutureOr<void> Function(String textLoading) onLoading}) async {
  ...
  void navigate({
    ...
    await completerEnsureInitialized.future;
    context.routerGeneralLibFlutter().pushReplacementNamed(routeName: "/");
  }
  ...
  Widget themeChangeWidget({required BuildContext context, required GeneralLibFlutterStatefulWidget pageState}) {
...
///
abstract class ExampleClientFlutterAppStatefulWidget extends GeneralFrameworkClientFlutterAppStatefulWidget<ExampleClientFlutter> {
  ///
...
///
abstract class ExampleClientFlutterAppStatelessWidget extends GeneralFrameworkClientFlutterAppStatelessWidget<ExampleClientFlutter> {
  ///
